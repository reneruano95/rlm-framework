...
Identical 1,033-token prompt (first 4,555 chars of `s0/fixtures/fix32k.txt`), `n_predict 128`, `cache_prompt: false`, `temperature 0`, `seed 1`, serial requests, 5 reps, server-reported `timings`.
