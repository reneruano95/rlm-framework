...
for jsonl, log, off in [("s2/results/arch_ladder_qwen-hybrid.jsonl", "s2/logs/arch-qwen.err", None),
                        ("s2/results/arch_ladder_gemma-fullattn.jsonl", "s2/logs/arch-gemma.err", None)]:
