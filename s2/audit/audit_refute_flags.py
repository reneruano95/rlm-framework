...
logs = {
 "arch-qwen": "s2/logs/arch-qwen.err",
 "arch-gemma": "s2/logs/arch-gemma.err",
 "arch-q35": "s2/logs/arch-q35.err",
 "bos": "s2/logs/bos.err",
 "slotfix-qwen": "s2/logs/slotfix-qwen.err",
 "origgeom": "s2/logs/origgeom.err",
