...
out=io.open("s2/audit/_xcheck_out.txt","w",encoding="utf-8",errors="replace")
...
recs=[json.loads(l) for l in open("s2/results/distance.jsonl",encoding="utf-8") if l.strip()]
...
a=[json.loads(l) for l in open("s2/results/refusal-ab.jsonl",encoding="utf-8") if l.strip()]
b=[json.loads(l) for l in open("s2/results/refusal-ab-640.jsonl",encoding="utf-8") if l.strip()]
