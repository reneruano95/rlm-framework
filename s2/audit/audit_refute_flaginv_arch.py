...
out=io.open("s2/audit/_arch2_out.txt","w",encoding="utf-8",errors="replace")
def P(*a): out.write(" ".join(str(x) for x in a)+"\n")

for p,lab in [("s2/results/arch_ladder_qwen-hybrid.jsonl","QWEN-HYBRID"),
              ("s2/results/arch_ladder_gemma-fullattn.jsonl","GEMMA-FULLATTN")]:
...
for p,lab in [("s2/logs/arch-qwen.err","arch-qwen"),("s2/logs/arch-gemma.err","arch-gemma"),("s2/logs/bos.err","bos")]:
    rows=[]
