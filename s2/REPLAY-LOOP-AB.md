...
**Date:** 2026-08-21 · **Script:** `s2/replay_loop_ab.py` · **Raw:** `s2/results/replay-loop-ab/{dflash4,mtp2,base,mtp2-b10375,dflash4-r}.jsonl`, `run.log`, `*.server.log`, `stimuli/`
**Answers:** `s4/RESULTS-dflash2-rlm-only.md` § Findings, item 1 ("Replay A/B … owed before this finding is closed either way")
...
- **R4's ruling in `s4/RESULTS-dflash2-rlm-only.md` stands on its stated
