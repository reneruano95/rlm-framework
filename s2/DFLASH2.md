...
**Date:** 2026-08-19 · **Scripts:** `s2/mtp_bench.py` (unmodified), `s2/dflash2_bench.py` · **Raw:** `s2/results/mtp_d2-*_t0.0.jsonl`, `s2/results/mtp_d2-*_t0.7.jsonl`
...
1. **Losslessness is unverified, exactly as it is for MTP.** The byte-identity
   ...
   measured here exceeded 1/4 — which `s2/mtp_bench.py` already documents. So the
