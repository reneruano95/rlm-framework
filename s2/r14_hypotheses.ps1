# s2/R14.md -- characterising the defect once the host-cache arm comes back
...
#     connection. `s2/OCCUPANCY.md` §7 names this as one of the two candidates,
...
function Run-H {
  ...
  $argv = @("run", "--python", "3.12", "s2/run_occupancy.py",
