...
Question (s4/RESULTS-dflash2-rlm-only.md, Findings): two `rlm` episodes in the
...
servers.root (via s2/dflash2_bench.py's BASE_ARGV) so the arms differ only in
the binary and the speculative flags. Results: s2/results/replay-loop-ab/.
"""
...
OUT = PROJECT / "s2" / "results" / "replay-loop-ab"
STIM = OUT / "stimuli"
PORT = 8080
