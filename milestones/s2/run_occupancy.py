...
THE BLOCKER THIS EXISTS TO CLEAR (`milestones/s2/DISTANCE.md` §4b, §5). Identical work —
...
if str(REPO_ROOT) not in sys.path:  # `uv run milestones/s2/run_occupancy.py`
...
def base_flags(*, cont_batching: bool = True, ub: int = 512,
    ...
    ADDED 2026-08-14 for `milestones/s2/R14.md`. The defaults reproduce `BASE_FLAGS`
