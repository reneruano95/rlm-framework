...
**Date:** 2026-08-15 · **Script:** `milestones/s2/gate_ab.py` · **Raw:** `milestones/s2/results/gate_ab.jsonl`
...
`milestones/s2/fixtures-refusal-640-s*` cells is prefilled ONCE on a **never-reused slot**,
...
§8 aggregation ruling priced in `milestones/s2/aggregation_options.py`.
