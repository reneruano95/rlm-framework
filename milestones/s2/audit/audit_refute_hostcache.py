...
PATS={"prompt_cache_room":"making room for prompt cache entry",
      ...
      "alloc_line":"alloc:"}
for rel in ["milestones/s2/logs/arch-qwen.err","milestones/s2/logs/arch-gemma.err","milestones/s2/logs/origgeom.err",
            "milestones/s2/logs/slotfix-qwen.err","milestones/s2/logs/bos.err",
...
for rel in ["milestones/s2/logs/origgeom.err","milestones/s2/logs/slotfix-qwen.err","milestones/s2/logs/arch-qwen.err"]:
