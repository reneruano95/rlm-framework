...
for P,name in [(r"D:/PROJECTS/rlm-halo-framework/milestones/s2/logs/arch-qwen.err","arch-qwen"),
               (r"D:/PROJECTS/rlm-halo-framework/milestones/s2/logs/arch-gemma.err","arch-gemma")]:
