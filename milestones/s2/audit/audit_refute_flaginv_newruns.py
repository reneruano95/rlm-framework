...
out=io.open("milestones/s2/audit/_newruns_out.txt","w",encoding="utf-8",errors="replace")
def P(*a): out.write(" ".join(str(x) for x in a)+"\n")
for f in sorted(os.listdir("milestones/s2/results")):
    if f.startswith("arch_ladder_"):
        p="milestones/s2/results/"+f
