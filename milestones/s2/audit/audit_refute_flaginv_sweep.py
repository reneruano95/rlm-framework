...
out=io.open("milestones/s2/audit/_sweep_out.txt","w",encoding="utf-8")
def P(*a): out.write(" ".join(str(x) for x in a)+"\n")

recs=[json.loads(l) for l in open("milestones/s2/results/sweep.jsonl",encoding="utf-8") if l.strip()]
P("sweep n=",len(recs))
...
recs1=[json.loads(l) for l in open("milestones/s2/results/sweep-run1-shared-server.jsonl",encoding="utf-8") if l.strip()]
...
out.close()
print(open("milestones/s2/audit/_sweep_out.txt",encoding="utf-8").read())
