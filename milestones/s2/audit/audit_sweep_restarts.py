"""Did milestones/s2/results/sweep.jsonl really get a freshly launched leaf per cell?
...
~5-10 s of model load (milestones/s2/R13-slotcount.md measures 5.65 s warm / 9.9 s cold)
...
RESULTS = Path(r"D:\PROJECTS\rlm-halo-framework\milestones\s2\results")
