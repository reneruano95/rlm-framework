"""Align milestones/s2/results/arch_ladder_*.jsonl (which records `rendered_tokens`, the
...
if __name__ == "__main__":
    align(ROOT / "milestones/s2/results/arch_ladder_qwen-hybrid.jsonl", ROOT / "milestones/s2/logs/arch-qwen.err")
    align(ROOT / "milestones/s2/results/arch_ladder_gemma-fullattn.jsonl", ROOT / "milestones/s2/logs/arch-gemma.err")
