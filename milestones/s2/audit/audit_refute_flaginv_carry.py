import re, io, os
out=io.open("milestones/s2/audit/_carry_out.txt","w",encoding="utf-8")
...
for name,p in [("arch-qwen","milestones/s2/logs/arch-qwen.err"),("arch-gemma","milestones/s2/logs/arch-gemma.err"),
...
out.close()
print(open("milestones/s2/audit/_carry_out.txt",encoding="utf-8").read())
