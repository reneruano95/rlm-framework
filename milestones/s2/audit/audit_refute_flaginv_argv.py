...
out=io.open("milestones/s2/audit/_argv_out.txt","w",encoding="utf-8")
def P(*a): out.write(" ".join(str(x) for x in a)+"\n")

for path,lab in [("milestones/s2/results/occupancy.jsonl","OCCUPANCY"),("milestones/s2/results/r14.jsonl","R14")]:
...
recs=[json.loads(l) for l in open("milestones/s2/results/cache_instrument.jsonl",encoding="utf-8") if l.strip()]
...
out.close()
print(open("milestones/s2/audit/_argv_out.txt",encoding="utf-8").read())
