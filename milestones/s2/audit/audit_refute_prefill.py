...
for rel,name in [("milestones/s2/logs/arch-qwen.err","arch-qwen"),("milestones/s2/logs/arch-gemma.err","arch-gemma"),
                 ("milestones/s2/logs/bos.err","bos"),("milestones/s2/logs/slotfix-qwen.err","slotfix-virgin+shared"),
                 ("milestones/s2/logs/origgeom.err","origgeom"),
