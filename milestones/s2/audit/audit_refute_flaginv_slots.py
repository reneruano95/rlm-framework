...
# DISTANCE
recs,_ = slotdoc("milestones/s2/results/distance.jsonl","slot_id","chunk_sha256",None,"DISTANCE distance.jsonl")
...
# REFUSAL-AB / 640
for p,lab in [("milestones/s2/results/refusal-ab.jsonl","REFUSAL-AB"),("milestones/s2/results/refusal-ab-640.jsonl","REFUSAL-AB-640")]:
...
slotdoc("milestones/s2/results/occupancy.jsonl","id_slot","doc","run_id","OCCUPANCY")
slotdoc("milestones/s2/results/r14.jsonl","id_slot","doc","run_id","R14")
slotdoc("milestones/s2/results/cache_instrument.jsonl","returned_slot","prompt_sha256","run_id","CACHE-INSTRUMENT (returned_slot x prompt_sha)")
slotdoc("milestones/s2/results/cache_instrument.jsonl","requested_slot","doc_key","run_id","CACHE-INSTRUMENT (requested_slot x doc_key)")

# SWEEP
recs,_=slotdoc("milestones/s2/results/sweep.jsonl","slot_id","chunk_sha256",None,"SWEEP")
...
recs,_=slotdoc("milestones/s2/results/sweep-run1-shared-server.jsonl","slot_id","chunk_sha256",None,"SWEEP-RUN1-SHARED")
print("  distinct chunk_sha256:", len({r["chunk_sha256"] for r in recs}))
