...
Run one arm per server launch, same prompts every time:
    ...
    uv run --python 3.12 --no-project milestones/s2/mtp_bench.py --label base

    # arm 1, MTP at the spec's pinned draft-n
    #   ... --spec-type draft-mtp --spec-draft-n-max 2
    uv run --python 3.12 --no-project milestones/s2/mtp_bench.py --label mtp2
    ...
    uv run --python 3.12 --no-project milestones/s2/mtp_bench.py --label mtp6-ngram

    uv run --python 3.12 --no-project milestones/s2/mtp_bench.py --compare
"""
