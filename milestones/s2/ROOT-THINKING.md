...
**Date:** 2026-08-15 · **Scripts:** `milestones/s2/root_thinking.py`, `milestones/s2/root_multiturn.py`
**Raw:** `milestones/s2/results/root_thinking.jsonl`, `milestones/s2/results/root_multiturn.jsonl`
...
Qwen3.8-27B's template (read from the GGUF, `milestones/s2/gguf_compare.py`) exposes three
