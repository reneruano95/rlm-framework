...
**Date:** 2026-08-14 · **Script:** `milestones/s2/carryover.py`
**Raw:** `milestones/s2/results/carryover_prod.jsonl`, `carryover_prod640.jsonl`
**Server:** production geometry, `-c 327680 -np 128 -ctk q8_0 -ctv q8_0 -fa on
-ub 512 -b 2048 -lm none --no-kv-unified --cont-batching`
(`n_slots = 128, n_ctx_slot = 2560`, from `milestones/s2/logs/carryover.err`)
...
production hits at high `max_subcalls`. Measured with `milestones/s2/carryover_depth.py`,
