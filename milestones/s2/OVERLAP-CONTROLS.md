...
- **The §7 #2 distance-cliff and false-positive findings.** They were measured per-chunk on `milestones/s2/results/sweep.jsonl`, which audits clean for R13 (117 calls, 0 foreign identifiers), and no part of them depends on whether windows tile or overlap.
