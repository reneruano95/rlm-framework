...
**Raw records:** `milestones/s0/results/raw.jsonl` (every run, timestamped). Fixture: `milestones/s0/fixtures/fix32k.txt` = exactly 32,768 leaf tokens (deterministic seed 1).
