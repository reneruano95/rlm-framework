...
_Generated 2026-08-16T17:25:19+00:00 by `milestones/s3/run_s3.py --phase report` from `milestones/s3/results/runs.jsonl` and the trace store `milestones/s3/results/store/`. Numbers come from the store, not process memory._
